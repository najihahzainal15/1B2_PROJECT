...
<html>
<head>
  <title>EVENT ADVISOR GENERATE ATTENDANCE QR</title>
 ...
 <div class="nav">
	<div class="menu">
		...
		<div class="item">
			...
			<div class="sub-menu">
				<a class="active" href="ea_attendanceSlot.php" class="sub-item">Attendance Slot</a>
			</div>
		</div>
	</div>
  </div>
  ...
  <br>
    ...
    <br><br>
      ...
      <div>
        <button class="submit-button" onclick="releaseQR()">RELEASE QR</button>
        <button class="submit-button" onclick="alert('Download started')">DOWNLOAD</button>
      </div>
  </div>
  </div>


  <!-- Hidden QR Released Confirmation -->
  <div id="qrConfirmation" style="display: none; text-align: center; margin-top: 40px;">
    <div style="background-color: white; border: 2px solid #0074e4; padding: 30px; display: inline-block; border-radius: 10px;">
      <p style="color: green; font-size: 18px; font-weight: bold;"><i class="fas fa-check-circle"></i> QR RELEASED SUCCESSFULLY</p>
      <button class="submit-button" onclick="document.getElementById('qrConfirmation').style.display='none'">DONE</button>
    </div>
  </div>

  <script>
    function releaseQR() {
      document.getElementById('qrConfirmation').style.display = 'block';
    }
  </script>
  </div>
</body>
