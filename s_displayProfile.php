...
<html>
<head>
  <title>STUDENT DISPLAY PROFILE</title>
...
<body>
  ...
  <div class="form-header">
    <a class="update-button" href="s_edit_profile.php?id=<?php echo $ID; ?>">Update Profile</a> 
  </div>
  <form method="POST" class="form"> 
		...
		<label>Programme</label><br>
			<input type="text" name="programme" class="select1" value="<?php echo $sProgramme; ?>" readonly><br>
		
		<label>Year of Study</label><br>
			<input type="text" name="year_of_study" class="select2" value="<?php echo $sYear; ?>" readonly><br>
			
		<label>Password</label><br>
			<input type="password" name="currpass" class="details3" value="<?php echo $currpass; ?>" readonly><br>

		<br>
		<a class="cancel-button" href="s_homepage.php">Cancel</a>
