...
<head>
	<title>COORDINATOR DISPLAY PROFILE</title>
	...
	<body>
		...
		<div class="content">
			...
			<div class="form-header">
				<a class="update-button" href="c_edit_profile.php?id=<?php echo $ID; ?>">Update Profile</a>
			</div>
			<form method="POST" class="form">
				...
				<input type="text" name="eventAdvisorID" class="details2" value="<?php echo $coordinatorID; ?>" readonly><br>
				...
				<br>
				<a class="cancel-button" href="c_homepage.php">Cancel</a>
