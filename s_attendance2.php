...
<html>
<head>
  <title>STUDENT ATTENDANCE VERIFICATION 2</title>
...
<body>
  ...
  <div class="nav">
    ...
    <div class="table-container">
      ...
      <div class="section-header">NEW EVENT</div>

      <div class="form-grid">
        <label>EVENT NAME</label>
        <input type="text" value="CYBERSECURITY FUN RUN 2025" readonly>

        <label>DATE</label>
        <input type="text" value="15 MAY 2025" readonly>

        <label>TIME</label>
        <input type="text" value="9AM - 12PM" readonly>

        <label>GEOLOCATION</label>
        <input type="text" value="2.9285,101.7715 (Faculty of Computing)" readonly>

        <label>DESCRIPTION</label>
        <input type="text" value="This Fun Run Aims to increase student fitness while answering networking questions to improve knowledge" readonly>
      </div>
      <div class="scan">
        <button class="scan-button">SCAN ATTENDANCE QR</button>
      </div>
