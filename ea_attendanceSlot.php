...
<head>
	...
	<style>
		...
		/* Standardized Search Container Styling */
		.search-container {
			width: 80%;
			margin: 20px auto;
			max-width: 600px;
		...
		/* Standardized Search Box Styling */
		.search-box {
			width: 100%;
			padding: 12px;
			box-sizing: border-box;
		...
		/* Standardized Search Button Styling */
		.search-btn {
			background-color: #0074e4;
			font-family: 'Poppins', sans-serif;
			border: none;
		...
		/* Standardized Search Results Message */
		.search-results {
			color: #666;
			font-style: italic;
			width: 80%;
	...
	<div class="nav">
		<div class="menu">
			...
			<div class="item">
				...
				<div class="sub-menu">
					<a href="ea_attendanceSlot.php" class="sub-item active">Attendance Slot</a>
				</div>
			</div>
		</div>
	</div>
